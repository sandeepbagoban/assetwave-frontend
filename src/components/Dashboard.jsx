...
const DONUT_DATA = [
  { label: 'Active', count: '12,394', pct: 67, color: '#7B5EF8' },
  { label: 'Surplus', count: '3,128', pct: 17, color: '#22D3EE' },
  ...
  return (
    <div style={{ position: 'relative', width: size, height: size }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'var(--font-display)', fontSize: 20, fontWeight: 800, color: '#fff', lineHeight: 1 }}>18,742</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 64, alignItems: 'center' }}>
          ...
          <div>
            <div style={{
              ...
              color: 'var(--purple3)', marginBottom: 14,
            }}>Real-Time Intelligence</div>
            <h2 style={{
              fontFamily: 'var(--font-display)', fontSize: 36, fontWeight: 800,
              color: '#fff', lineHeight: 1.15, letterSpacing: '-0.5px', marginBottom: 16,
                ...
                <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    ...
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                      <path d="M2 5l2.5 2.5L8 3" stroke="#7B5EF8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: 'var(--text3)', background: 'var(--surface)', padding: '4px 10px', borderRadius: 6 }}>
                May 1 – May 31, 2025 📅
              </div>
            </div>
            ...
            <div style={{
              ...
              {METRICS.map((m, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 800, color: '#fff', lineHeight: 1 }}>{m.value}</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr 1fr', gap: 0 }}>
              ...
              <div style={{ padding: 18, borderRight: '1px solid var(--border)' }}>
                ...
                <Sparkline data={SPARKLINE_DATA} color="#7B5EF8" />
