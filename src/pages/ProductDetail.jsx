        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: 48 }}>
          <div>
            <div style={{
              ...
              background: listing.images?.[0] ? `center/cover no-repeat url(${resolveAssetUrl(listing.images[0])})` : 'linear-gradient(160deg, #1A1430, #0F0F1A)',
          ...
          <div>
            ...
            <div style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 18, padding: 24, marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, color: 'var(--violet3)', fontWeight: 500, marginTop: 18, marginBottom: 18 }}>
                <ShieldCheck size={15} /> Escrow protected — funds released only after you confirm delivery
              </div>
